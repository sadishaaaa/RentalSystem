...
const Checkout = () => {
  ...
  return (
    ...
    >
      <Link to={`/payment?fullName=${currentUser.customerName}&phoneNumber=${currentUser.contact_no}&emailAddress=${currentUser.email}&address=${currentUser.address}&shippingOption=${shippingOption}&total=${total}&item=${itemName}`}>Cash on Delivery</Link>
    </Button>
